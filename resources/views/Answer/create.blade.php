...
@section('main')
    <form class="grid-x grid-padding-x grid-padding-y bg-white px-2" method="POST" action="{{route('answer.store')}}">
        @csrf
        ...
        <div class="cell small-12 medium-10">
            <input id="solution" name="solution" type="text" class="my-0" required>
        </div>

        <label for="isCorrect" class="cell small-12 medium-2 font-bold">Correct</label>
        <div class="cell small-12 medium-10">
            <input id="isCorrect" name="isCorrect" class="switch-input" type="checkbox" checked>
